...
public class FileConstant {
	...
	public static final String DIRECTORY_CREATED = "Create directory for:";
	public static final String DEFAULT_USER_IMAGE_PATH = "user/image/profile/";
	public static final String FILE_SAVED_IN_FILE_SYSTEM = "saved file in the system by name:";
	public static final String DOT = ".";
	public static final String FORWARD_SLASH = "/";
	public static final String TEMP_PROFILE_IMAGE_BASE_URL = "http://rohohash.org/";
